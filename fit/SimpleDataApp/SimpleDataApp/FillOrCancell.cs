...
{
    public partial class FillOrCancell : Form
    {
        public FillOrCancell()
        {
            InitializeComponent();
        }
                ...
                using (SqlConnection connection = new SqlConnection(Properties.Settings.Default.connString))
                {
                    ...
                    using (SqlCommand sqlCommand = new SqlCommand(sql, connection))
                    {
                        ...
                        try
                        {
                            ...
                            {
                                //Create a data table to hold the retreived data
                                DataTable dataTable = new DataTable();

                                //Load the data from SqlDataReader into the data table
                                dataTable.Load(dataReader);

                                //Display the data from the data table in the data grid vie
        ...
        private void btnFillOrder_Click(object sender, EventArgs e)
        {
            if (IsOrderIDValid())
            {
                ...
                using (SqlConnection connection = new SqlConnection(Properties.Settings.Default.connString))
                {
                    //Create Command and identify it as stored procedure
