...
namespace SimpleDataApp
{
    public partial class NewCustomer : Form
    {
        ...
        {
            //Verify that Customer ID is present
            ...
            if (IsCustomerNameValid())
            {
                ...
                using (SqlConnection connection = new SqlConnection(Properties.Settings.Default.connString))
                {
                    ...
                    using (SqlCommand sqlCommand = new SqlCommand("Sales.uspPlaceNewOrder", connection))
                    {
                        ...
                        sqlCommand.Parameters.Add(new SqlParameter("@Customer.ID", SqlDbType.Int));
                        sqlCommand.Parameters["@Customer.ID"].Value = this.parsedCustomerID;

                        // Add the @OrderDate input parameter.
                        sqlCommand.Parameters.Add(new SqlParameter("@OrderDate", SqlDbType.DateTime, 8));
                        sqlCommand.Parameters["@OrderDate"].Value = dtpOrderDate.Value;

                        //Add the @Amount order amount parameter
                        ...
                        catch (Exception)
                        {
                            ...
                            MessageBox.Show("Order chould not be placed.");
                        }
                        finally
                        {
                            connection.Close();
